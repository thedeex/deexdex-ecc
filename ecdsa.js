...
const Buffer = require("safe-buffer").Buffer; // https://tools.ietf.org/html/rfc6979#section-3.2
...
function sign(curve, hash, d, nonce) {
  const e = _bigi.default.fromBuffer(hash);
  ...
  let N_OVER_TWO = n.shiftRight(1); // enforce low S values, see bip62: 'low s values in signatures'
